...
_ZIP_PREFIX_STATE = {
    ...
    "197":"DE","198":"DE","199":"DE","200":"DC","202":"DC","203":"DC","204":"DC","205":"DC",
    ...
    "959":"CA","960":"CA","961":"CA","970":"OR","971":"OR","972":"OR","973":"OR","974":"OR","975":"OR","976":"OR","977":"OR","978":"OR","979":"OR",
    "980":"WA","981":"WA","982":"WA","983":"WA","984":"WA","985":"WA","986":"WA","988":"WA","989":"WA",
    "990":"WA","991":"WA","992":"WA","993":"WA","994":"WA",
    "995":"AK","996":"AK","997":"AK","998":"AK","999":"AK","967":"HI","968":"HI",
}
...
_STATE_CENTROIDS = {
    "Alabama":(32.7794,-86.8287),"Alaska":(64.0685,-153.3695),"Arizona":(34.2744,-111.6602),
    "Arkansas":(34.8938,-92.4426),"California":(37.1841,-119.4696),"Colorado":(38.9972,-105.5478),
    "Connecticut":(41.6219,-72.7273),"Delaware":(38.9896,-75.5050),"District of Columbia":(38.9047,-77.0163),
    "Florida":(28.6305,-82.4497),"Georgia":(32.6415,-83.4426),"Hawaii":(20.2927,-156.3737),
    "Idaho":(44.3509,-114.6130),"Illinois":(40.0417,-89.1965),"Indiana":(39.8942,-86.2816),
    "Iowa":(42.0751,-93.4960),"Kansas":(38.4937,-98.3804),"Kentucky":(37.5347,-85.3021),
    "Louisiana":(31.0689,-91.9968),"Maine":(45.3695,-69.2428),"Maryland":(39.0550,-76.7909),
    "Massachusetts":(42.2596,-71.8083),"Michigan":(44.3467,-85.4102),"Minnesota":(46.2807,-94.3053),
    "Mississippi":(32.7364,-89.6678),"Missouri":(38.3566,-92.4580),"Montana":(47.0527,-109.6333),
    "Nebraska":(41.5378,-99.7951),"Nevada":(39.3289,-116.6312),"New Hampshire":(43.6805,-71.5811),
    "New Jersey":(40.1907,-74.6728),"New Mexico":(34.4071,-106.1126),"New York":(42.9538,-75.5268),
    "North Carolina":(35.5557,-79.3877),"North Dakota":(47.4501,-100.4659),"Ohio":(40.2862,-82.7937),
    "Oklahoma":(35.5889,-97.4943),"Oregon":(43.9336,-120.5583),"Pennsylvania":(40.8781,-77.7996),
    "Rhode Island":(41.6762,-71.5562),"South Carolina":(33.9169,-80.8964),"South Dakota":(44.4443,-100.2263),
    "Tennessee":(35.8580,-86.3505),"Texas":(31.4757,-99.3312),"Utah":(39.3055,-111.0937),
    "Vermont":(44.0687,-72.6658),"Virginia":(37.5215,-78.8537),"Washington":(47.3826,-120.4472),
    "West Virginia":(38.6409,-80.6227),"Wisconsin":(44.6243,-89.9941),"Wyoming":(42.9957,-107.5512),
}
...
def fetch_all_courses(from_date=None):
    today = date.today()
    far_future = (today + timedelta(days=365 * 15)).strftime("%Y-%m-%d")
    from_date = from_date or today.strftime("%Y-%m-%d")

    base_params = {
        "country": "us", "language": "en-us", "extend_to_limit": "1",
        "start_date_to": far_future, "field_childrens": "true",
        "offset": "1", "type": "country", "ctype": _YOUTH_CTYPES,
    }
...
def api_courses():
    ...
    try:
        courses = fetch_all_courses(from_date)
...
def geocode_zip(zip_code):
    ...
    try:
        resp = requests.get(f"https://api.zippopotam.us/us/{zip_code}", timeout=8)
...
def find_teachers():
    ...
    for t in results:
        name = re.sub(r"\s*\([^)]*\)", "", f"{t['first_name']} {t['last_name']}")
        t["slug"] = re.sub(r"[^a-z0-9]+", "-", name.lower()).strip("-")
